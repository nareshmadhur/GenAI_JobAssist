...
2.  **Work Experience**: List job titles, companies, and dates. For each role, create 2-3 bullet points (using -) describing achievements and responsibilities. **Bold** metrics and skills that directly match the job description to make them stand out.
3.  **Skills**: A bulleted list (using -) of technical and soft skills. Prioritize skills mentioned in the job description.
